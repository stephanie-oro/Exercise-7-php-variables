<?php
  ...
  $currentYear = date("Y");
  $graduatingYear = 2012;
  $roughYears = $currentYear - $graduatingYear;
...
<html lang="en">
  ...
  <body>
    <main class="container py-4">
      ...
      <?php echo '<p>You graduated highschool in '.$graduatingYear.', so you have been out of highschool for about '.$roughYears.' years.</p>'; ?>
